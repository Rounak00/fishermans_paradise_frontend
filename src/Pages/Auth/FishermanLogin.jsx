  ...
  return (
    <div className="flex items-center justify-center">
      <div className="h-max flex flex-col md:w-1/2 p-4 justify-center items-center ">
        <h1 className="mt-10">Fisherman Login </h1>
        <form
        ...
        <h1 className="mt-4"> Don't have an Account, <Link className='text-primary font-semibold' to="/fisherman-register">Click Here</Link></h1>
      </div>
    </div>
  );
};
